...
[TOP 5 Price In Category] = CASE 
								...
								ELSE 'NO' 
							END,
[Category PriceRank With Rank] = RANK() OVER(PARTITION BY pc.[Name] ORDER BY[ListPrice] DESC)
...
[TOP 5 Price In Category] = CASE 
							...
							END,
[Category PriceRank With Rank] = RANK() OVER(PARTITION BY pc.[Name] ORDER BY[ListPrice] DESC),
[Category PriceRank With DENSE_RANK] = DENSE_RANK() OVER(PARTITION BY pc.[Name] ORDER BY[ListPrice] DESC)
